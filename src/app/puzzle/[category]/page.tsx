...
export default function PuzzlePage({
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-yellow-100 via-pink-100 to-purple-100 p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto w-full">
        ...
        {/* Category Title */}
        <div className={`bg-linear-to-r ${info.color} rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 mb-4 sm:mb-6 md:mb-8 text-center shadow-lg`}>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 md:p-9 lg:p-12 shadow-2xl mb-4 sm:mb-6">
          ...
          <div className="mb-6 sm:mb-8 md:mb-10">
            ...
            <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center py-6 sm:py-8 md:py-10 lg:py-12 bg-gray-50 rounded-xl sm:rounded-2xl wrap-break-word px-3 sm:px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mb-4 sm:mb-6">
            {currentPuzzle.options.map((option, index) => (
              <button
                ...
                disabled={showResult}
                className={`p-6 sm:p-8 md:p-10 lg:p-12 rounded-xl sm:rounded-2xl text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold transition-all transform active:scale-95 sm:hover:scale-105 min-h-[120px] sm:min-h-[140px] md:min-h-40 lg:min-h-[180px] flex items-center justify-center ${
                  showResult
          ...
          {showResult && (
            <div className="text-center px-2">
              ...
              {!isLastPuzzle ? (
                <button
                  onClick={handleNext}
                  className="px-6 py-3 sm:px-8 sm:py-4 bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-xl sm:rounded-2xl text-base sm:text-lg md:text-xl font-bold hover:shadow-lg transform active:scale-95 sm:hover:scale-105 transition-all"
                >
                  Next Puzzle ➡️
                </button>
              ) : (
                <div>
                  ...
                  <div className="flex gap-2 sm:gap-4 justify-center flex-wrap">
                    <button
                      ...
                      className="px-4 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-xl sm:rounded-2xl text-sm sm:text-base md:text-xl font-bold hover:shadow-lg transform active:scale-95 sm:hover:scale-105 transition-all"
                    >
                      🔄 Play Again
                    </button>
                    <Link
                      href="/"
                      className="px-4 py-3 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-linear-to-r from-blue-500 to-cyan-500 text-white rounded-xl sm:rounded-2xl text-sm sm:text-base md:text-xl font-bold hover:shadow-lg transform active:scale-95 sm:hover:scale-105 transition-all inline-block"
                    >
                      🏠 New Category
                    </Link>
                  </div>
